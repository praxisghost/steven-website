/* catalan-srs-fr.js — Català for French speakers.
...
(function () {
  ...
  const WORDS = [
    ...
    ["home", "homme"],
    ["dona", "femme"],
    ["nen / nena", "garçon / fille"],
    ["mare", "mère"],
    ["pare", "père"],
    ["fill / filla", "fils / fille"],
    ["germà / germana", "frère / sœur"],
    ["amic / amiga", "ami / amie"],
    ["família", "famille"],
    ["aigua", "eau"],
    ["menjar", "manger / nourriture"],
    ["beure", "boire"],
    ["pa", "pain"],
    ["vi", "vin"],
    ["formatge", "fromage"],
    ...
    ["bonic", "joli / beau"],
    ["ràpid", "rapide"],
    ["a poc a poc", "lentement"],
    ["nou / nova", "neuf / nouvelle"],
    ["vell", "vieux"],
    ["què?", "quoi ?"],
    ["qui?", "qui ?"],
    ["on?", "où ?"],
